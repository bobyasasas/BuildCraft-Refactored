...
**总任务数 28** ｜ pending(未完成)=19、in_progress(进行中)=0、partial(部分完成)=0、unverified(未验证)=0、done(已完成)=9 ｜ **完成率 32%**（权重：done=1，in_progress/partial/unverified=0.5，pending=0）
