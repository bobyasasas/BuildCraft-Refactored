...
>
> 生成时间：2026-09-15 03:30:35 ｜ 数据源：migration/tasks.json（schema=1，updated=2026-09-15）
...
采集时间：2026-09-15 03:30:35；采集范围：仓库根目录（排除 .git、.gradle、build、buildcraft_resources_generated）。
