 ...
 * block; the M4.7 machines (tank, distiller, heat exchange, pump) and the M4.16 machines (autoworkbench item, chute,
 * flood gate, mining well) carry their real behaviour classes (the ids are unchanged, so the registry parity gate is
 * unaffected).
 */
public final class BcFactoryBlockEntities {
    ...
    /** {@code buildcraftfactory:autoworkbench_item}; real class since M4.16 ({@link AutoworkbenchItemBlockEntity}). */
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<AutoworkbenchItemBlockEntity>> AUTOWORKBENCH_ITEM = BLOCK_ENTITIES
            .register("autoworkbench_item", () -> new BlockEntityType<>(AutoworkbenchItemBlockEntity::new,
                    BcFactoryBlocks.AUTOWORKBENCH_ITEM.value()));

    /** {@code buildcraftfactory:chute}; real class since M4.16 ({@link ChuteBlockEntity}). */
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ChuteBlockEntity>> CHUTE = BLOCK_ENTITIES
            .register("chute", () -> new BlockEntityType<>(ChuteBlockEntity::new,
    ...
    /** {@code buildcraftfactory:flood_gate}; real class since M4.16 ({@link FloodGateBlockEntity}). */
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<FloodGateBlockEntity>> FLOOD_GATE = BLOCK_ENTITIES
            .register("flood_gate", () -> new BlockEntityType<>(FloodGateBlockEntity::new,
    ...
    /** {@code buildcraftfactory:mining_well}; real class since M4.16 ({@link MiningWellBlockEntity}). */
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<MiningWellBlockEntity>> MINING_WELL = BLOCK_ENTITIES
            .register("mining_well", () -> new BlockEntityType<>(MiningWellBlockEntity::new,
