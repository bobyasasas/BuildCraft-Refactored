...
public final class BcEnergyItems {
    ...
    public static final DeferredItem<BucketItem> FUEL_DENSE_HEAT_0_BUCKET = BcLangKeys.item(ITEMS, "fuel_dense_heat_0_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_DENSE_HEAT_1_BUCKET = BcLangKeys.item(ITEMS, "fuel_dense_heat_1_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_DENSE_HEAT_2_BUCKET = BcLangKeys.item(ITEMS, "fuel_dense_heat_2_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_GASEOUS_HEAT_0_BUCKET = BcLangKeys.item(ITEMS, "fuel_gaseous_heat_0_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_GASEOUS_HEAT_1_BUCKET = BcLangKeys.item(ITEMS, "fuel_gaseous_heat_1_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_GASEOUS_HEAT_2_BUCKET = BcLangKeys.item(ITEMS, "fuel_gaseous_heat_2_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_LIGHT_HEAT_0_BUCKET = BcLangKeys.item(ITEMS, "fuel_light_heat_0_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_LIGHT_HEAT_1_BUCKET = BcLangKeys.item(ITEMS, "fuel_light_heat_1_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_LIGHT_HEAT_2_BUCKET = BcLangKeys.item(ITEMS, "fuel_light_heat_2_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_MIXED_HEAVY_HEAT_0_BUCKET = BcLangKeys.item(ITEMS, "fuel_mixed_heavy_heat_0_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_MIXED_HEAVY_HEAT_1_BUCKET = BcLangKeys.item(ITEMS, "fuel_mixed_heavy_heat_1_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_MIXED_HEAVY_HEAT_2_BUCKET = BcLangKeys.item(ITEMS, "fuel_mixed_heavy_heat_2_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_MIXED_LIGHT_HEAT_0_BUCKET = BcLangKeys.item(ITEMS, "fuel_mixed_light_heat_0_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_MIXED_LIGHT_HEAT_1_BUCKET = BcLangKeys.item(ITEMS, "fuel_mixed_light_heat_1_bucket",
    ...
    public static final DeferredItem<BucketItem> FUEL_MIXED_LIGHT_HEAT_2_BUCKET = BcLangKeys.item(ITEMS, "fuel_mixed_light_heat_2_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_DENSE_HEAT_0_BUCKET = BcLangKeys.item(ITEMS, "oil_dense_heat_0_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_DENSE_HEAT_1_BUCKET = BcLangKeys.item(ITEMS, "oil_dense_heat_1_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_DENSE_HEAT_2_BUCKET = BcLangKeys.item(ITEMS, "oil_dense_heat_2_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_DISTILLED_HEAT_0_BUCKET = BcLangKeys.item(ITEMS, "oil_distilled_heat_0_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_DISTILLED_HEAT_1_BUCKET = BcLangKeys.item(ITEMS, "oil_distilled_heat_1_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_DISTILLED_HEAT_2_BUCKET = BcLangKeys.item(ITEMS, "oil_distilled_heat_2_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_HEAT_0_BUCKET = BcLangKeys.item(ITEMS, "oil_heat_0_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_HEAT_1_BUCKET = BcLangKeys.item(ITEMS, "oil_heat_1_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_HEAT_2_BUCKET = BcLangKeys.item(ITEMS, "oil_heat_2_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_HEAVY_HEAT_0_BUCKET = BcLangKeys.item(ITEMS, "oil_heavy_heat_0_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_HEAVY_HEAT_1_BUCKET = BcLangKeys.item(ITEMS, "oil_heavy_heat_1_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_HEAVY_HEAT_2_BUCKET = BcLangKeys.item(ITEMS, "oil_heavy_heat_2_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_RESIDUE_HEAT_0_BUCKET = BcLangKeys.item(ITEMS, "oil_residue_heat_0_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_RESIDUE_HEAT_1_BUCKET = BcLangKeys.item(ITEMS, "oil_residue_heat_1_bucket",
    ...
    public static final DeferredItem<BucketItem> OIL_RESIDUE_HEAT_2_BUCKET = BcLangKeys.item(ITEMS, "oil_residue_heat_2_bucket",
    ...
    public static final DeferredItem<Item> GLOB_OIL = BcLangKeys.item(ITEMS, "glob_oil");

    /** Placeholder for {@code buildcraftenergy:oil_placer} (legacy {@code ItemOilPlacer}); behaviour class migrates in M2.5+. */
    public static final DeferredItem<Item> OIL_PLACER = BcLangKeys.item(ITEMS, "oil_placer");
    ...
    public static final DeferredItem<BlockItem> MJ_DYNAMO = BcLangKeys.blockItem(ITEMS, BcEnergyBlocks.MJ_DYNAMO);
