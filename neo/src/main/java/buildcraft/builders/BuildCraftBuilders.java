...
/**
 * BuildCraft builders mod entry point for the NeoForge 26.1.2 port (task M2.4a eight-mod skeleton). Legacy
 * counterpart: {@code buildcraft.builders.BCBuilders}. Placeholder registrations (see the {@code BcBuilders*}
